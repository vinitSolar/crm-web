            ...
            {step === 'compose' ? (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                disabled={sending}
                            />
                            <p className="text-xs text-gray-400">Hidden recipients</p>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-500">Click or drag files to attach</p>
                        ...
                        <div className="bg-amber-50 p-3 rounded-lg text-xs text-amber-700 border border-amber-200">
                            <p className="flex items-start gap-2">
                                ...
                                <span>Variables in the template will be replaced with each customer's details (e.g. <code className="bg-amber-100 px-1 rounded">{"[[FIRST_NAME]]"}</code>).</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col h-full">
                        {!selectedTemplateUid ? (
                            <div className="flex-1 border border-gray-200 rounded-lg flex items-center justify-center min-h-[400px] bg-white">
                            ...
                            <div className="flex-1 flex flex-col rounded-lg overflow-hidden border border-gray-200 bg-white">
                                {/* Form-style Header */}
                                <div className="border-b border-gray-200">
                                    ...
                                    <div className="flex items-center px-4 py-2 border-b border-gray-100">
                                        ...
                                        <div className="flex-1 text-sm text-gray-800">
                                            {isPreviewLoading ? (
                                                <span className="animate-pulse bg-gray-200 rounded h-4 w-48 inline-block"></span>
                                    ...
                                    {ccList.length > 0 && (
                                        <div className="flex items-center px-4 py-2 border-b border-gray-100">
                                            ...
                                            <div className="flex-1 flex flex-wrap gap-1">
                                                {ccList.map((email, i) => (
                                                    <span key={i} className="inline-flex items-center px-2 py-0.5 bg-blue-50 text-blue-700 text-xs rounded-full">
                                                        {email}
                                                    </span>
                                                ))}
                                            </div>
                                    ...
                                    {bccList.length > 0 && (
                                        <div className="flex items-center px-4 py-2 border-b border-gray-100">
                                            <span className="text-sm text-gray-500 w-16">Bcc</span>
                                            <div className="flex-1 flex flex-wrap gap-1">
                                                {bccList.map((email, i) => (
                                                    <span key={i} className="inline-flex items-center px-2 py-0.5 bg-gray-100 text-gray-600 text-xs rounded-full">
                                                        {email}
                                                    </span>
                                                ))}
                                            </div>
                                    ...
                                    <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
                                        <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            {attachments.map((file, i) => (
                                                <span key={i} className="inline-flex items-center gap-1 px-2 py-1 bg-white border border-gray-200 text-xs text-gray-700 rounded">
                                ...
                                <div className="flex-1 overflow-y-auto p-4">
                                    {isPreviewLoading ? (
                                        <div className="flex items-center justify-center py-12 text-gray-400">
                                            <div className="animate-spin rounded-full h-6 w-6 border-2 border-gray-300 border-t-indigo-500 mr-3"></div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col">
                        <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-xl p-6 mb-4">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Sending to <span className="font-semibold text-primary">{selectedCustomerIds.length}</span> customer{selectedCustomerIds.length > 1 ? 's' : ''}
                                    </p>
                                </div>
                            </div>
                        ...
                        {/* Summary Details */}
                        <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4 flex-1">
                            <h4 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">Email Details</h4>

                            <div className="space-y-3">
                                <div className="flex items-start gap-3 pb-3 border-b border-gray-100">
                                    <span className="text-sm text-gray-500 w-24 flex-shrink-0">Template</span>
                                    <span className="text-sm font-medium text-gray-900">{selectedTemplate?.name || '—'}</span>
                                </div>
                                <div className="flex items-start gap-3 pb-3 border-b border-gray-100">
                                    <span className="text-sm text-gray-500 w-24 flex-shrink-0">Subject</span>
                                    <span className="text-sm text-gray-700">{selectedTemplate?.subject || '—'}</span>
                                </div>
                                <div className="flex items-start gap-3 pb-3 border-b border-gray-100">
                                    <span className="text-sm text-gray-500 w-24 flex-shrink-0">Recipients</span>
                                ...
                                {ccEmails && (
                                    <div className="flex items-start gap-3 pb-3 border-b border-gray-100">
                                        <span className="text-sm text-gray-500 w-24 flex-shrink-0">CC</span>
                                ...
                                {bccEmails && (
                                    <div className="flex items-start gap-3 pb-3 border-b border-gray-100">
                                        <span className="text-sm text-gray-500 w-24 flex-shrink-0">BCC</span>
                                        <div className="flex flex-wrap gap-1">
                                            {bccList.map((email, i) => (
                                                <span key={i} className="inline-flex px-2 py-0.5 bg-gray-100 text-gray-600 text-xs rounded-full">
                                                    {email}
                                                </span>
                                            ))}
                                        </div>
                                ...
                                {attachments.length > 0 && (
                                    <div className="flex items-start gap-3">
                                        <span className="text-sm text-gray-500 w-24 flex-shrink-0">Attachments</span>
                                        <div className="flex flex-wrap gap-2">
                                            {attachments.map((file, i) => (
                                                <span key={i} className="inline-flex items-center gap-1 px-2 py-1 bg-gray-50 border border-gray-200 text-xs text-gray-700 rounded">
                                                    <svg className="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
                                                    </svg>
                                                    {file.name}
                    ...
                    <div className="flex flex-col">
                        <div className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-3">Email Preview</div>
                                ...
                                <div className="flex items-center px-4 py-2 border-b border-gray-100">
                                    ...
                                    <div className="flex-1 text-sm text-gray-800">
                                        {isSingleCustomer && previewCustomer ? (
                                            ...
                                            <span className="text-gray-500">{selectedCustomerIds.length} recipients</span>
                                        )}
                                    </div>
                                </div>
                                <div className="flex items-center px-4 py-2">
