...
const getStatusBadge = (status: number | null) => {
    switch (status) {
        case 0: return { label: 'Pending', bg: 'bg-amber-100 text-amber-700' };
        case 1: return { label: 'In Progress', bg: 'bg-blue-100 text-blue-700' };
        case 2: return { label: 'Submitted', bg: 'bg-purple-100 text-purple-700' };
        case 3: return { label: 'Signed', bg: 'bg-green-100 text-green-700' };
        default: return { label: 'Unknown', bg: 'bg-gray-100 text-gray-700' };
    }
};
...
const StatCard = ({ title, count, customers, accentColor, isExpanded, onToggle }: StatCardProps) => {
    return (
        <div className="flex flex-col">
                        ...
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {customers.map((customer) => {
                                    ...
                                    return (
                                        <tr key={customer.uid} className="hover:bg-gray-50 text-sm">
            ...
            {isExpanded && customers.length === 0 && (
                <div className="mt-2 bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
        ...
        return (
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Customer summary overview</p>
                </div>
